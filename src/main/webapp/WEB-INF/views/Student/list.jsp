						...
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								...
								<div class="ibox-tools">
									<a href="addStudent" class="btn btn-primary btn-xs"><i
											...
											<c:if test="${studentList != null}">
												<c:forEach items="${studentList}" var="student">
													<tr>
														...
														<td><c:out value="${student.rowCreated}" /></td>
														<td><a href="editStudent?id=<c:out value="${student.userId}" />">Edit</a>&nbsp;|&nbsp;<a href="deleteStudent?id=<c:out value="${student.userId}" />">Delete</a></td>
													</tr>
												</c:forEach>
											</c:if>
