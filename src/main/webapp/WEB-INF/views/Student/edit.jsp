							...
							<div class="col-lg-12">
								<div class="ibox float-e-margins">
									...
									<div class="ibox-content">
										...
										<form:form class="form-horizontal" action="updateStudent"
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<form:input type="text" placeholder="Email Address"
														...
														path="emailAddress" readonly="readonly"/>
												...
												<div class="col-lg-4">
													<select name="department" class="form-control">
														<c:forEach items="${departmentList}" var="dept">
															<c:choose>
															<c:when test="${dept.departmentName == student.department}">
												...
												<div class="col-lg-4">
													<select name="year" class="form-control">
														<c:forEach items="${yearList}" var="year">
															<c:choose>
															<c:when test="${year.year == student.year}">
												...
												<div class="col-lg-4">
													<select name="groupName" class="form-control">
														<c:forEach items="${groupList}" var="group">
															<c:choose>
															<c:when test="${group.groupName == student.groupName}">
