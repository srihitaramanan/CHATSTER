							...
							<div class="col-lg-12">
								<div class="ibox float-e-margins">
									...
									<div class="ibox-content">
										...
										<form:form class="form-horizontal" name="staff" action="saveStaff"
											...
											<div class="form-group">
												<label class="col-lg-4 control-label required">User Type</label>
												<div class="col-lg-4">
													<select name="userRole" class="form-control" id="role" required="required">
														<option value="">Select User Type</option>
														<c:forEach items="${roleList}" var="role">
														<c:if test="${role.authority == 'ROLE_STAFF'}">
															<option value="${role.authority}" selected="selected"> ${role.authority}</option>
														</c:if>
															
														</c:forEach>
													</select> <span id="roleErr" style="color: red"></span>
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-4 control-label">Select Group</label>
												<div class="col-lg-4">
													<select name="groupName" class="form-control"  required="required">
